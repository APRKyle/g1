...
class Pather:
    def __init__(self, min_lenght, min_dist, max_distance):
        ...
        self.rot_mat = np.array([[1.6341274404419635, 0.19316408412226166, -0.12845465161541444],
     [0.005999550033748842, -0.622774720467394, -0.7006617360840779],
     [0.3989700772442051, -0.7002331967959551, 0.5488516932658601]])
        self.trans_mat = np.array([74.76232139732359, -124.83270897539833, 144.33913885030037])
