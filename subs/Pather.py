...
class Pather:
    def __init__(self, camera, min_lenght, min_dist):
        ...
        self.rot_mat = np.array([[1.2964813306073508,-0.09100272085837686,-0.36293483774768254],
                                [0.03781531981615042,-0.7520022135796963,-0.6342520713879454],
                                [0.509738213456718,-0.5432493505295676,0.6374802084454195]])

        self.trans_mat = np.array([79.16360506048893,-34.08723656095816,230.02733156042038])
